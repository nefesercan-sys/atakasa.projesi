      ...
      <section style={{
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", position: "relative", zIndex: 1 }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 24 }}>
            ...
            <div style={{ flex: 1, minWidth: 280 }}>
              ...
              <h2 style={{
                ...
                <span style={{ color: "#c9a84c" }}>A</span>-TAKASA
                <br />
                <span style={{ fontSize: "55%", color: "rgba(255,255,255,.7)", fontWeight: 700 }}>
                  Sat. Takasla. İster Et. Büyü.
                </span>
              </h2>
            ...
            <div style={{ display: "flex", gap: 12, flexWrap: "wrap", justifyContent: "flex-end" }}>
              {[
                ...
                { icon: "🔄", sayi: "12K+", label: "Takas Yapıldı" },
          ...
          <div style={{ marginTop: 28, display: "flex", gap: 10, flexWrap: "wrap", alignItems: "center" }}>
            <span style={{ color: "rgba(255,255,255,.4)", fontSize: ".78rem", fontWeight: 600 }}>Popüler:</span>
            {[
              { label: "💻 Elektronik", kat: "Elektronik" },
              { label: "🚗 Araç", kat: "Araç" },
              { label: "🏠 Emlak", kat: "Emlak" },
              { label: "🎮 Oyun/Konsol", kat: "Oyun/Konsol" },
              { label: "🏺 Antika", kat: "Antika Eserler" },
            ].map(item => (
              <button key={item.kat}
                onClick={() => { setAktifKategori(item.kat); window.scrollTo({ top: 500, behavior: "smooth" }); }}
                style={{
