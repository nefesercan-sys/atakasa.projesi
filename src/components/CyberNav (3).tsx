  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        >
          <Link href="/" onClick={closeModal} style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "3px", textDecoration: "none" }}>
            <span style={{ fontSize: "22px", lineHeight: 1 }}>🏠</span>
            <span style={{ fontSize: "9px", fontWeight: 800, letterSpacing: "0.08em", textTransform: "uppercase", color: pathname === "/" && !activeModal ? "#00f260" : "#64748b" }}>VITRIN</span>
          </Link>

          <button onClick={() => setActiveModal(activeModal === "sectors" ? null : "sectors")} style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "3px", background: "none", border: "none", cursor: "pointer" }}>
            <span style={{ fontSize: "22px", lineHeight: 1 }}>🗂️</span>
            <span style={{ fontSize: "9px", fontWeight: 800, letterSpacing: "0.08em", textTransform: "uppercase", color: activeModal === "sectors" ? "#00f260" : "#64748b" }}>SEKTOR</span>
          </button>

          <div style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
            <button
              onClick={() => setActiveModal(activeModal === "ilan" ? null : "ilan")}
              style={{ width: "58px", height: "58px", borderRadius: "50%", background: "#00f260", border: "none", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 0 20px rgba(0,242,96,0.4), 0 4px 15px rgba(0,0,0,0.3)", position: "relative", top: "-18px", flexShrink: 0 }}
            >
              <span style={{ fontSize: "26px", lineHeight: 1 }}>⚡</span>
            </button>
          </div>

          <Link href={session ? "/mesajlar" : "/giris"} onClick={closeModal} style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "3px", textDecoration: "none", position: "relative" }}>
            <div style={{ position: "relative", lineHeight: 1 }}>
              <span style={{ fontSize: "22px" }}>💬</span>
              <span style={{ position: "absolute", top: "-2px", right: "-4px", width: "8px", height: "8px", background: "#00f260", borderRadius: "50%", border: "2px solid #0a0a0a" }} />
            </div>
            <span style={{ fontSize: "9px", fontWeight: 800, letterSpacing: "0.08em", textTransform: "uppercase", color: pathname.startsWith("/mesajlar") ? "#00f260" : "#64748b" }}>MESAJ</span>
          </Link>

          <Link href={session ? "/panel" : "/giris"} onClick={closeModal} style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "3px", textDecoration: "none" }}>
            <span style={{ fontSize: "22px", lineHeight: 1 }}>👤</span>
            <span style={{ fontSize: "9px", fontWeight: 800, letterSpacing: "0.08em", textTransform: "uppercase", color: pathname.startsWith("/panel") ? "#00f260" : "#64748b" }}>PANEL</span>
          </Link>
        </div>

        <div style={{ position: "absolute", bottom: "calc(env(safe-area-inset-bottom) + 2px)", left: "50%", transform: "translateX(-50%)", fontSize: "8px", fontWeight: 900, color: "#00f260", letterSpacing: "0.1em", textTransform: "uppercase", whiteSpace: "nowrap", pointerEvents: "none" }}>
          AT TAKASA
        </div>
      </nav>
    </React.Fragment>
