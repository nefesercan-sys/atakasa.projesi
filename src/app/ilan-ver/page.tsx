        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div>
              ...
              <p style={{ fontSize: 11, color: textSoft, margin: 0 }}>
              ...
              <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 24 }}>
                ...
                <div>
                  ...
                  <input
                    ...
                    style={inputStyle}
                    onFocus={e => e.target.style.borderColor = "#0f2540"}
                ...
                <div>
                  ...
                  <div
                    ...
                    onMouseEnter={e => { if (!isUploading) (e.currentTarget as HTMLElement).style.borderColor = "#0f2540"; }}
