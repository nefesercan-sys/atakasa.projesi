    ...
    <>
      <div style={{
        ...
        <div
          className="giris-sol"
          style={{
            width: "45%", background: "var(--navy, #0f2540)",
        ...
        >
          <div style={{ position: "relative", zIndex: 2 }}>
            <div style={{
              ...
              A-TAKASA<span style={{ color: "var(--gold, #c9a84c)" }}>.</span>
            </div>
        ...
        <div style={{
          ...
          <div style={{ width: "100%", maxWidth: 420 }}>
            ...
            <div style={{ marginBottom: 28 }}>
              ...
              <p style={{ fontSize: 14, color: "var(--text-soft, #8097b1)", margin: 0 }}>
            ...
            {error && (
              <div style={{
                ...
                border: "1px solid #f5c6c2", borderRadius: 12,
                padding: "12px 16px", fontSize: 13,
                color: "var(--danger, #c0392b)", fontWeight: 500,
            ...
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 7 }}>
                <label style={{
                  ...
                  letterSpacing: "0.06em", color: "var(--text-mid, #4a5e78)",
                ...
                <input
                  ...
                  style={{
                    ...
                    color: "var(--navy, #0f2540)", outline: "none", boxSizing: "border-box" as const,
                  }}
                  onFocus={e => { e.target.style.borderColor = "#0f2540"; e.target.style.background = "#fff"; }}
                  onBlur={e => { e.target.style.borderColor = "#dce6f0"; e.target.style.background = "#faf8f4"; }}
                />
              </div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 7 }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  ...
                  <Link href="/sifremi-unuttum" style={{
                    fontSize: 12, color: "var(--gold, #c9a84c)",
              ...
              <label style={{ display: "flex", alignItems: "flex-start", gap: 10, cursor: "pointer" }}>
                <input
                  type="checkbox" checked={sozlesmeKabul}
                  onChange={(e) => setSozlesmeKabul(e.target.checked)}
                  style={{
                    width: 16, height: 16,
                    accentColor: "var(--navy, #0f2540)",
                    flexShrink: 0, marginTop: 2, cursor: "pointer",
                  }}
                />
                <span style={{ fontSize: 12, color: "var(--text-mid, #4a5e78)", lineHeight: 1.6 }}>
                  Giriş yaparak{" "}
                  <Link href="/sozlesme" style={{ color: "var(--gold, #c9a84c)", fontWeight: 600, textDecoration: "none" }}>
                    Kullanıcı Sözleşmesini
                  </Link>{" "}ve{" "}
                  <Link href="/kvkk" style={{ color: "var(--gold, #c9a84c)", fontWeight: 600, textDecoration: "none" }}>
                    KVKK Metnini
                  </Link>{" "}kabul ediyorum.
                </span>
              </label>
              ...
              <button
                ...
                style={{
                  ...
                  background: loading || !sozlesmeKabul
                    ? "var(--text-soft, #8097b1)"
                    : "var(--navy, #0f2540)",
                  border: "none", borderRadius: 12,
                  fontFamily: "inherit", fontSize: 14, fontWeight: 700,
                  color: "#fff",
                  cursor: loading || !sozlesmeKabul ? "not-allowed" : "pointer",
                  display: "flex", alignItems: "center", justifyContent: "center",
                  gap: 8, letterSpacing: "0.01em", marginTop: 4,
                  transition: "all 0.2s",
                  opacity: loading || !sozlesmeKabul ? 0.7 : 1,
                }}
              >
                {loading ? (
                  <>
                    <span style={{
                      ...
                      animation: "giris-spin 0.7s linear infinite",
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12, margin: "24px 0" }}>
              <div style={{ flex: 1, height: 1, background: "var(--border, #dce6f0)" }} />
              <span style={{ fontSize: 12, color: "var(--text-soft, #8097b1)" }}>veya</span>
              <div style={{ flex: 1, height: 1, background: "var(--border, #dce6f0)" }} />
            </div>

            <p style={{ textAlign: "center", fontSize: 13, color: "var(--text-mid, #4a5e78)", margin: 0 }}>
              Ağda kimliğin yok mu?{" "}
              <Link href="/kayit" style={{
                color: "var(--gold, #c9a84c)", fontWeight: 700, textDecoration: "none",
            ...
            <div style={{ marginTop: 16, textAlign: "center" }}>
              <Link href="/" style={{
                ...
                fontSize: 12, color: "var(--text-soft, #8097b1)", textDecoration: "none",
                padding: "8px 16px",
